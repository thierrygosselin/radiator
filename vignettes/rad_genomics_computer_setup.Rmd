...
**Time to allow: ETA ~20 min for experience users, 1h for novices**
...
**Ventura and Monterey** [gcc-11.2-bin.tar.gz](http://prdownloads.sourceforge.net/hpc/gcc-11.2-bin.tar.gz)
...
We want [clang](https://en.wikipedia.org/wiki/Clang) compiler with OpenMP enabled. The latest version is [15.0.3](https://github.com/llvm/llvm-project/releases/tag/llvmorg-15.0.3).
...
To install R v4.2.1 **"Funny-Looking Kid"** released on 2022-06-23 download the
...
**With macOS** version 12.0.1 (Monterey): follow the `.Makevars` [configuration](#Makevars_config)
