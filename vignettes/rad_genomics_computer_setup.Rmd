...
* the current version is macOS Monterey 12.0.1
...
To install R v4.1.2 **"Bird Hippie "** released on 2021-11-01 download the
installer and follow the instructions
```{bash eval=FALSE}
# for macOS
cd Downloads
curl -O https://cran.r-project.org/bin/macosx/R-4.1.2.pkg
```
