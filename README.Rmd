...
R/RStudio to crash under macOS [details](https://github.com/Rdatatable/data.table/issues/2418). The quick solution is to install data.table version 1.10.4. I'm currently working on removing data.table dependency in *radiator*
...
For previous news:
[NEWS.md file](https://github.com/thierrygosselin/radiator/blob/master/NEWS.md)
